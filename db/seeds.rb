...
PlayerPosition.create("team_player_id"=>1, "position_id"=>2)
...
PlayerPosition.create("team_player_id"=>3, "position_id"=>2)
PlayerPosition.create("team_player_id"=>3, "position_id"=>4)
