...
ActiveRecord::Schema.define(version: 20141210033524) do
  ...
  create_table "player_images", force: true do |t|
    t.integer  "team_player_id"
    t.string   "image"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "player_images", ["team_player_id"], name: "index_player_images_on_team_player_id"
