  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved team_member as @team_member" do
        ...
        post :create, {:team_member => {  }}, valid_session
        assigns(:team_member).should be_a_new(TeamMember)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested team_member" do
        ...
        TeamMember.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => team_member.to_param, :team_member => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the team_member as @team_member" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TeamMember.any_instance.stub(:save).and_return(false)
        put :update, {:id => team_member.to_param, :team_member => {  }}, valid_session
        assigns(:team_member).should eq(team_member)
      end
